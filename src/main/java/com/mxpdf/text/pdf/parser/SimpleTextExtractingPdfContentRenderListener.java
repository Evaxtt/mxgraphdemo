...
public class SimpleTextExtractingPdfContentRenderListener implements TextProvidingRenderListener {
     ...
     * @see RenderListener#renderText(String, GraphicsState, Rectangle)
     */

    /**
     * Captures text using a simplified algorithm for inserting hard returns and spaces
     * @see com.mxpdf.text.pdf.parser.AbstractRenderListener#renderText(String, GraphicsState, Matrix, Matrix)
     */
