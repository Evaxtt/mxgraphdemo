...
public final class PdfPatternPainter extends PdfTemplate {
    ...
    /**
     * @see PdfContentByte#addImage(com.mxpdf.text.Image, float, float, float, float, float, float)
     */
    ...
    /**
     * @see PdfContentByte#setColorStroke(Color)
     */
    ...
    /**
     * @see PdfContentByte#setColorFill(Color)
     */
    ...
    /**
     * @see PdfContentByte#setPatternFill(PdfPatternPainter, Color, float)
     */
    ...
    /**
     * @see PdfContentByte#setPatternStroke(PdfPatternPainter, Color, float)
     */
