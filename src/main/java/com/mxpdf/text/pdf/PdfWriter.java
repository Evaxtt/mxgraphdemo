...
//	[C2] PdfVersion interface
	...
	/**
	 * @see PdfVersion#addDeveloperExtension(com.mxpdf.text.pdf.PdfDeveloperExtension)
	 * @since	2.1.6
	 */
...
//  [C8] AcroForm
    ...
    /** @see PdfAnnotations#addAnnotation(com.mxpdf.text.pdf.PdfAnnotation) */
    ...
    /** @see PdfAnnotations#addCalculationOrder(com.mxpdf.text.pdf.PdfFormField) */
...
//  [U3] page actions (open and close)
    ...
    /** @see PdfPageActions#setTransition(com.mxpdf.text.pdf.PdfTransition) */
