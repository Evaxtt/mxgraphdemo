...
Actions.prototype.init = function()
{
	...
	this.addAction('saveAs...', function() { ui.saveFile(true); }, true, null, Editor.ctrlKey + '+Shift+S').isEnabled = isGraphEnabled;
	this.addAction('export...', function() { ui.showDialog(new ExportDialog(ui).container, 300, 296, true, true); });
    // this.addAction('exportHtml', function() {
    //     ui.createHtml(mxUtils.bind(this, function(html, scriptTag)
    //         {
    //             var basename = "test";
    ...
    //                 '<meta charset="utf-8"/>\n</head>\n<body>' + html + '\n' + scriptTag + '\n</body>\n</html>';
    //             // ui.saveData(basename + '.html', 'html', result, 'text/html');
    //         }));
    // });
