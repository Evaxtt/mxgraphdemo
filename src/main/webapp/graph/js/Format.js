...
Format.prototype.refresh = function()
{
    ...
    // 自定义html
    var echartPopup = document.createElement('div')
    var inputs = document.createElement('input')
    var texts = document.createElement('text')
    inputs.type='checkbox';
    texts.innerText='是否添加填充样式';
    echartPopup.appendChild(inputs)
    echartPopup.appendChild(texts)
    echartPopup.style.display='none'
    //
    ...
    // var echartPopup=document.getElementById('testPopup');
    ...
    else
    {
        ...
        // inputs.oninput=function () {
        // 	if (inputs.checked){
        // 		console.log(that.selectionState.vertices[0]);
        // 	} else {
        // 		return;
        // 	}
        // }
//
        ...
        //
        // for (let i = 1; i < ECElement.length; i++) {
        ...
        // 	Sidebar.prototype.myChart=myChart;
        // 	Sidebar.prototype.option=option;
        // 	// echart下所有元素设置100%
...
// 		console.log(option);
// 		console.log(myChart);
        // var myChart=Sidebar.prototype.myChart
        // var option=Sidebar.prototype.option
        ...
        var Popup = label3.cloneNode(false);
        // Workaround for ignored background in IE
        label2.style.backgroundColor = this.inactiveTabBackgroundColor;
        label3.style.backgroundColor = this.inactiveTabBackgroundColor;

        Popup.style.backgroundColor = this.inactiveTabBackgroundColor;

        //自定义
        // var Popup = label.cloneNode(false);
        mxUtils.write(Popup, "自定义");
        div.appendChild(Popup);
        // echartPopup.style.display = 'none';
        this.container.appendChild(echartPopup);
        ...
        addClickHandler(Popup, echartPopup, idx++);
